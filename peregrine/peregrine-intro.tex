...
schedules on many inputs, and can enforce full determinism with reasonable
overhead.
...
extremely challenging to understand, test, analyze, verify, or replicate all
these schedules in a multithreaded program. Therefore, a concurency bug within
