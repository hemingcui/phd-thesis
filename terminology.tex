...
%% Title stuff.
%\newcommand{\thesistitle}[0]{Stable Multithreading: A New Paradigm for Reliable and Secure Threads}
...
\newcommand{\acmtechnews}[0]{\v{ACM Tech News}\xspace}
\newcommand{\tgdaily}[0]{\v{TG Daily}\xspace}
\newcommand{\physorg}[0]{\v{Physorg}\xspace}
