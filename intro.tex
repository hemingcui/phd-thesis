...
of magnitudes (Chapter~\ref{sec:parrot}) for model checking, an advanced technique that systematically
...
applications, we have also proposed \crane, a preliminary
system design that leverages \smt to create practical state machine replication
service, a critical and popular fault-tolerant technique
in today's distributed systems and clouds, for multithreaded programs (Chapter~\ref{sec:crane}).
