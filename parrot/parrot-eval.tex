...
\begin{figure*}[tb]
\centering
\includegraphics[width=\textwidth]{parrot/figures/hints}
\vspace{-.20in}
\caption{{\em Effects of performance hints.} They reduced \parrot's overhead from \overallnohints to \overallhints.} \label{fig:overhead-hints}
\vspace{-.05in}
\end{figure*}
...
Figure~\ref{fig:overhead-hints} compares \parrot's performance with and
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{parrot/figures/comparison}
\vspace{-.2in}
\caption{{\em \parrot, \dthreads, and \coredet overhead.}} \label{fig:comparison}
\vspace{-.0in}
\end{figure}
