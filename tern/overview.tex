This chapter describes \tern, our first \smt (and also \dmt) system that
...
%% P2: state why we also want DMT. Because it is especially useful for testing
%% and debugging.

%% P3: A typical DMT system has the instability problem. Reuse paragraphs in
%% TERN paper.

%% P4: Our solution that addresses the challenge as well as the instability
%% problem...
