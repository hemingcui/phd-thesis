...
programs. Building a multithreading system that is both stable and 
deterministic is challenging, because as we described in 
...
challenges on building a multithreading system that is both stable and deterministic with a 
...
\tern is the first multithreading system that is both stable and deterministic, the first to 
