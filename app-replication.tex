...
%% P4
\msmr is the first system for transparently replicating multi-threaded server 
programs with XXX. TBD. First, TBD. Second, TBD. Third, TBD.

%% P5
Extra pracitcal challenge of \msmr: systematic checkpoint and recovery.

%% P6
\msmr has broad applications: it enables heavyweight concurrency analysis at 
deployment. race detections. DFT.

%% P7
Discussion on \msmr's fundamental limitations/assumptions.
