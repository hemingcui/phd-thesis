...
%% P7
By integrating with a pracitcal \smr runtime system \parrot and 
performing consensus on the socket interface, \msmr is easy to use and deploy,
...
\smr can also practically capture  this kind of divergence (\eg, caused by data races) by running a 
