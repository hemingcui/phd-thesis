...
it does not help much on reducing the number of schedules for all inputs of a
multithreaded program.  We believe the community has charged nondeterminism more
