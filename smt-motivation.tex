...
programs, because concurrency bugs may show up in some replicas and cause
...
Researchers have computed a small set of schedules to practically cover all
inputs for some multithreaded programs~\cite{ics:oopsla13} by leveraging some
...
integrating \smt with replication service in Chapter~\ref{sec:crane}.
